...
const ProductsCarousel: React.FC<ProductsCarouselProps> = ({
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between mb-5 md:mb-6 mx-10">
        <SectionHeader sectionHeading={sectionHeading} className="mb-0" />
        <Link
          href={categorySlug ? `${categorySlug}` : 'buscar'}
          className="text-brand text-brand:hover text-xs mb-1 text-black font-bold md:text-lg"
        >
          Ver más »
        </Link>
      </div>
