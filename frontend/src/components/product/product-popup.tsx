            ...
            <div className="items-center justify-center mb-6 overflow-hidden xl:flex md:mb-8 lg:mb-0">
              {!!gallery?.length ? (
                ...
                <div className="flex items-center justify-center w-auto">
                  <Image
                    loader={() =>
                      images[0].image.url ?? productGalleryPlaceholder
                    }
                    src={images[0].image.url ?? productGalleryPlaceholder}
                    alt={title!}
                    width={650}
                    height={590}
                  />
            ...
            <div className="shrink-0 flex flex-col lg:ltr:pl-5 lg:rtl:pr-5 xl:ltr:pl-8 xl:rtl:pr-8 2xl:ltr:pl-10 2xl:rtl:pr-10 lg:w-[430px] xl:w-[470px] 2xl:w-[480px]">
              <div className="pb-5">
                ...
                {unit && isEmpty(variations) ? (
                  <div className="text-sm font-medium md:text-15px">
                    {unit == 1
                      ? 'Es ' + unit + ' unidad por compra'
                      : 'Son ' + unit + ' unidades por compra'}
                  </div>
                ) : (
                  <VariationPrice
                  ...
                  <>
                    {Number(quantity) > 0 || outOfStock ? null : (
                      ...
                      <span className="text-sm font-medium text-yellow">
                        {'Solo queda' + ' ' + quantity + ' ' + 'disponible(s)'}
                      </span>
              ...
              <div className="pt-1.5 lg:pt-3 xl:pt-4 space-y-2.5 md:space-y-3.5">
                ...
                <Button
                  ...
                  disabled={Number(quantity) <= 0 || outOfStock}
              ...
              <div className="pt-6 xl:pt-8">
                ...
                <Text variant="small">
                  {descripcion.split(' ').slice(0, 40).join(' ')}
                  {'...'}
                  <span
                    onClick={navigateToProductPage}
                    role="button"
