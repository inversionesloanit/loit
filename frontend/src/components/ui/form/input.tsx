...
const classes = {
  ...
  normal: 'bg-gray-100 border-gray-300 focus:shadow focus:text-brand-light  ',
  solid:
    'text-brand-dark border-border-two focus:border-2 focus:outline-none   h-11 md:h-12',
