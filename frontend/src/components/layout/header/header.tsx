...
const Header: React.FC = () => {
  ...
  return (
    <header
      ...
      ref={siteHeaderRef}
      className={cn(
        '!bg-[#013fb8] header-two sticky-header sticky top-0 z-20 lg:relative w-full h-16 lg:h-auto',
        displayMobileSearch && 'active-mobile-search'
      )}
    >
      <div className="z-20 w-screen transition-all duration-200 ease-in-out innerSticky lg:w-full body-font">
        <Search
        ...
        <div className="hidden navbar bg-brand lg:block">
          <Container className="flex items-center justify-between h-28">
