...
const Header: React.FC = () => {
  ...
  return (
    <header
      ...
      ref={siteHeaderRef}
      className={cn(
        '!bg-[#013fb8] header-one w-full h-16 lg:h-20 z-30 sticky top-0',
        displayMobileSearch && 'active-mobile-search'
      )}
    >
      <div className="z-20 bg-brand w-full h-16 transition duration-200 ease-in-out innerSticky body-font bg-brand-light lg:h-20">
