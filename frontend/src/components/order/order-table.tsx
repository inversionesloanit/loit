  ...
  const columns = [
    ...
    },
    {
      ...
      render: function actionsButton(item: any) {
        return (
          <button
            onClick={() => route.push('ordenes/' + item.id)}
      ...
      <div className="items-center mb-5 md:flex md:justify-between sm:mb-10">
        ...
        <form onSubmit={onSubmitHandle} className="relative">
          ...
          <Input
            ...
            inputClassName=" h-[46px] w-full bg-white border border-[#E3E8EC] rounded-md order-search focus:border-2 focus:outline-none   focus:text-brand-muted"
          />
        </form>
      </div>
