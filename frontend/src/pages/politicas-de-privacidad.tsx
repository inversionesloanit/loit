...
export default function PrivacyPage() {
  ...
  return (
    <>
      <Seo title="Politicas de privacidad" description="" path="privacy" />
        ...
        <Container>
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-9/12 md:ltr:pl-8 md:rtl:pr-8">
              <p className="!mb-8 lg:mb-12 last:mb-0 order-list-enable">
                Esta Política de Privacidad describe cómo inverloan.com, como
                controlador de datos, recopila, utiliza y procesa su información
                personal. Al utilizar la Plataforma de inverloan.com, acepta los
